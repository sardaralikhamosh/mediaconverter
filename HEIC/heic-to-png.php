    ...
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        ...
        if ($file['size'] > 10 * 1024 * 1024) {
            ...
            try {
                ...
                $convertedDir = $baseDir . '/converted_pngs/';
                ...
                $pngFilename = pathinfo($filename, PATHINFO_FILENAME) . '.png';
                $pngPath = $convertedDir . $pngFilename;
                ...
                if (move_uploaded_file($file['tmp_name'], $heicPath)) {
                    ...
                    $downloadLink = '/HEIC/converted_pngs/' . $pngFilename;
                } else {
...
<head>
    ...
    <title>Convert HEIC to PNG</title>
        ...
        <div class="container-wrapper">
            <div class="col-md-8 col-md-offset-2">
                <div class="conversion-box">
                    <h2 class="text-center">HEIC to PNG Converter</h2>
                    <p class="text-center text-muted">Convert HEIC/HEIF images to PNG format</p>
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn btn-primary btn-block">
                            <span class="glyphicon glyphicon-convert"></span> Convert to PNG
                        </button>
                    </form>
                    ...
                    <?php if ($downloadLink): ?>
                        <div class="alert alert-success mt-20">
                            ...
                            <p>Your PNG file is ready:</p>
                            <a href="<?= htmlspecialchars($downloadLink) ?>" 
                               class="btn btn-success btn-block" download>
                               Download PNG
                            </a>
                            <div class="mt-10">
                                <a href="heic-to-png.php" class="btn btn-default btn-block">
