...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        ...
        if ($file['size'] > 10 * 1024 * 1024) {
            ...
            try {
                // Validate PDF file using Imagick
                $imagick = new Imagick();
                ...
                if (move_uploaded_file($file['tmp_name'], $pdfPath)) {
                    // Convert PDF to HEIC (first page only)
                    $imagick = new Imagick($pdfPath);
                    $imagick->setIteratorIndex(0); // Convert first page
                ...
                $uploadError = 'Invalid PDF file or conversion error.';
...
<head>
    ...
    <title>Convert PDF to HEIC</title>
        ...
        <div class="container-wrapper">
            <div class="col-md-8 col-md-offset-2">
                <div class="conversion-box">
                    <h2 class="text-center">PDF to HEIC Converter</h2>
                    <p class="text-center text-muted">Convert PDF documents to HEIC image format<br>
                    <small>Note: Only converts first page of multi-page PDFs</small></p>
                    ...
                    <?php if ($downloadLink): ?>
                        <div class="alert alert-success mt-20">
                            ...
                            <div class="mt-10">
                                <a href="pdf-to-heic.php" class="btn btn-default btn-block">
