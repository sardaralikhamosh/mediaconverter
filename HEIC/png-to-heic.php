...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        ...
        if ($file['size'] > 10 * 1024 * 1024) {
            ...
            try {
                // Validate PNG file using Imagick
                ...
                $uploadError = 'Invalid PNG file or conversion error.';
...
<head>
    ...
    <title>Convert PNG to HEIC</title>
        ...
        <div class="container-wrapper">
            <div class="col-md-8 col-md-offset-2">
                <div class="conversion-box">
                    <h2 class="text-center">PNG to HEIC Converter</h2>
                    <p class="text-center text-muted">Convert PNG images to HEIC format</p>
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="pngFile" class="form-control" 
                                   id="pngFile" accept=".png" required>
                        </div>
                    ...
                    <?php if ($downloadLink): ?>
                        <div class="alert alert-success mt-20">
                            ...
                            <div class="mt-10">
                                <a href="png-to-heic.php" class="btn btn-default btn-block">
