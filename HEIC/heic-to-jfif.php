    ...
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        ...
        if ($file['size'] > 10 * 1024 * 1024) {
            ...
            try {
                ...
                $convertedDir = $baseDir . '/converted_jfif/';
                ...
                $jfifFilename = pathinfo($filename, PATHINFO_FILENAME) . '.jfif';
                $jfifPath = $convertedDir . $jfifFilename;

                // Move uploaded file
                if (move_uploaded_file($file['tmp_name'], $heicPath)) {
                    // Convert HEIC to JFIF
                    $imagick = new Imagick($heicPath);
                    $imagick->setImageFormat('jfif');
                    ...
                    $downloadLink = '/HEIC/converted_jfif/' . $jfifFilename;
                } else {
...
<head>
    ...
    <title>Convert HEIC to JFIF</title>
        ...
        <div class="container-wrapper">
            <div class="col-md-8 col-md-offset-2">
                <div class="conversion-box">
                    <h2 class="text-center">HEIC to JFIF Converter</h2>
                    <p class="text-center text-muted">Convert HEIC/HEIF images to JFIF format</p>
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn btn-primary btn-block">
                            <span class="glyphicon glyphicon-convert"></span> Convert to JFIF
                        </button>
                    </form>
                    ...
                    <?php if ($downloadLink): ?>
                        <div class="alert alert-success mt-20">
                            ...
                            <p>Your JFIF file is ready:</p>
                            <a href="<?= htmlspecialchars($downloadLink) ?>" 
                               class="btn btn-success btn-block" download>
                               Download JFIF
                            </a>
                            <div class="mt-10">
                                <a href="heic-to-jfif.php" class="btn btn-default btn-block">
