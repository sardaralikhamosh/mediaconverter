...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        ...
        if ($file['size'] > 10 * 1024 * 1024) {
            ...
            try {
                // Validate WebP file using Imagick
                ...
                // Set directory paths
                $baseDir = __DIR__;
                $uploadDir = $baseDir . '/webp_uploads/';
                ...
                $uploadError = 'Invalid WebP file or conversion error.';
...
<head>
    ...
    <title>Convert WebP to HEIC</title>
        ...
        <div class="container-wrapper">
            <div class="col-md-8 col-md-offset-2">
                <div class="conversion-box">
                    <h2 class="text-center">WebP to HEIC Converter</h2>
                    <p class="text-center text-muted">Convert WebP images to HEIC format</p>
                    
                    <form method="post" enctype="multipart/form-data">
                        <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($_SESSION['csrf_token']) ?>">
                        
                        <div class="form-group">
                            <label for="webpFile">Select WebP File:</label>
                            <input type="file" name="webpFile" class="form-control" 
                                   id="webpFile" accept=".webp" required>
                        </div>
                    ...
                    <?php if ($downloadLink): ?>
                        <div class="alert alert-success mt-20">
                            ...
                            <div class="mt-10">
                                <a href="webp-to-heic.php" class="btn btn-default btn-block">
