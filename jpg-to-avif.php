...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['jpgFile'])) {
    ...
    if (in_array($file['type'], $allowedTypes)) {
        ...
        if (move_uploaded_file($file['tmp_name'], $jpgPath)) {
            ...
            $avifPath = 'converted/' . pathinfo($jpgPath, PATHINFO_FILENAME) . '.avif';

            // Convert JPG to AVIF using Imagick
            try {
        ...
        $uploadError = 'Please upload a valid JPG file.';
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Convert JPG to AVIF</title>
...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-center" style="height: 100vh; margin-top: 0;">
        <div class="content" style="width: 100%; max-width: 600px;">
            <h2 class="text-center">Convert JPG to AVIF</h2>
            <p class="text-center">Upload a JPG file to convert it to AVIF format.</p>
            ...
            <?php if ($downloadLink): ?>
                <div class="alert alert-success" style="margin-top: 20px;">
                    ...
                    <a href="jpg-to-avif.php" class="btn btn-secondary btn-block" style="margin-top: 10px;">Go Back</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
