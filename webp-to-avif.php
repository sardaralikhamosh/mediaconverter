...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['imageFile'])) {
    ...
    if ($file['type'] == 'image/webp') {
        ...
        if (move_uploaded_file($file['tmp_name'], $webpPath)) {
            ...
            $avifPath = 'converted/' . pathinfo($webpPath, PATHINFO_FILENAME) . '.avif';

            // Convert WEBP to AVIF using Imagick
            try {
...
<head>
    ...
    <title>Convert WEBP to AVIF</title>
...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-center" style="height: 100vh; margin-top: 0;">
        <div class="content" style="width: 100%; max-width: 600px;">
            <h2 class="text-center">Convert WEBP to AVIF</h2>
            <p class="text-center">Upload a WEBP file to convert it to AVIF format.</p>
            
            <form method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="imageFile">Choose WEBP file:</label>
            ...
            <?php if ($downloadLink): ?>
                <div class="alert alert-success" style="margin-top: 20px;">
                    ...
                    <a href="webp-to-avif.php" class="btn btn-secondary btn-block" style="margin-top: 10px;">Go Back</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
