...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['imageFile'])) {
    ...
    if ($file['type'] == 'image/avif') {
        ...
        if (move_uploaded_file($file['tmp_name'], $avifPath)) {
            ...
            $jfifPath = 'converted/' . pathinfo($avifPath, PATHINFO_FILENAME) . '.jfif';

            // Convert AVIF to JFIF using Imagick
            try {
...
<head>
    ...
    <title>Convert AVIF to JFIF</title>
...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-center" style="height: 100vh; margin-top: 0;">
        <div class="content" style="width: 100%; max-width: 600px;">
            <h2 class="text-center">Convert AVIF to JFIF</h2>
            <p class="text-center">Upload an AVIF file to convert it to JFIF format.</p>
            ...
            <?php if ($downloadLink): ?>
                <div class="alert alert-success" style="margin-top: 20px;">
                    ...
                    <a href="avif-to-jfif.php" class="btn btn-secondary btn-block" style="margin-top: 10px;">Go Back</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
