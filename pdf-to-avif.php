...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['pdfFile'])) {
    ...
    if ($file['type'] == 'application/pdf') {
        ...
        if (move_uploaded_file($file['tmp_name'], $pdfPath)) {
            ...
            $avifPath = 'converted/' . pathinfo($pdfPath, PATHINFO_FILENAME) . '.avif';

            // Convert PDF to AVIF using Imagick
            try {
                $imagick = new Imagick();
...
<head>
    ...
    <title>Convert PDF to AVIF</title>
...
<body>
 ...
 <div class="container d-flex align-items-center justify-content-center" style="height: 100vh; margin-top: 0;">
        <div class="content" style="width: 100%; max-width: 600px;">
            <h2 class="text-center">Convert PDF to AVIF</h2>
            <p class="text-center">Upload a PDF file to convert it to AVIF format.</p>
            ...
            <?php if ($downloadLink): ?>
                <div class="alert alert-success" style="margin-top: 20px;">
                    ...
                    <a href="pdf-to-avif.php" class="btn btn-secondary btn-block" style="margin-top: 10px;">Go Back</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
